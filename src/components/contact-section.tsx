...
export function ContactSection() {
    ...
    const {
        ...
        defaultValues: { name: "", email: "", subject: "", message: "", company: "", website: "" },
        mode: "onBlur",
    })
    ...
    return (
        ...
        >
            <div ref={ref} data-inview={inView} className="container-page relative reveal">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 max-w-[72rem]">
                    <div className="space-y-6">
                        {[
                            { icon: Mail, label: t("contactSection.emailLabel"), value: "fernandooibarra@gmail.com" },
                            { icon: Phone, label: t("contactSection.phoneLabel"), value: "(662) 291-4052" },
                            { icon: MapPin, label: t("contactSection.locationLabel"), value: t("contactSection.locationValue") },
                        ].map(({ icon: Icon, label, value }) => (
                            <div key={label} className="flex items-start gap-4 border-l border-border-strong pl-4">
                                <div className="w-9 h-9 rounded-md bg-foreground/5 flex items-center justify-center shrink-0">
                                    <Icon className="h-4 w-4 text-foreground" aria-hidden="true" />
                                </div>
                                <div>
                                    <p className="text-eyebrow uppercase text-muted-foreground mb-1">{label}</p>
                        ...
                        <a
                            ...
                            className="hidden lg:inline-flex mt-2 items-center gap-2 text-mono-sm text-signal-ink hover:underline"
                        >
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <label htmlFor="contact-name" className="text-mono-sm text-muted-foreground">
                                ...
                                />
                                {errors.name && (
                                    <p id="contact-name-err" role="alert" className="text-mono-sm text-signal-ink">
                                        {errors.name.message}
                                    </p>
                                )}
                            </div>
                            <div className="space-y-1.5">
                                <label htmlFor="contact-email" className="text-mono-sm text-muted-foreground">
                                ...
                                />
                                {errors.email && (
                                    <p id="contact-email-err" role="alert" className="text-mono-sm text-signal-ink">
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="contact-subject" className="text-mono-sm text-muted-foreground">
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="contact-message" className="text-mono-sm text-muted-foreground">
                            ...
                            />
                            {errors.message && (
                                <p id="contact-message-err" role="alert" className="text-mono-sm text-signal-ink">
