    ...
    <section id="experiencia" className="py-32 md:py-44 lg:py-56">
      <div ref={ref} data-inview={inView} className="container-page reveal">
        ...
        <div className="relative max-w-[60rem]">
          <div
            className="absolute left-[7.5rem] md:left-[10rem] top-0 bottom-0 w-px bg-border hidden md:block"
            aria-hidden="true"
          />
                    ...
                    <CardContent>
                      <ul className="space-y-2 mb-6">
                        {exp.description.map((d, idx) => (
                          ...
                          >
                            <span
                              className="mt-2.5 w-1 h-1 rounded-full bg-signal-ink shrink-0"
                              aria-hidden="true"
                            />
                            <span>{d}</span>
                          </li>
